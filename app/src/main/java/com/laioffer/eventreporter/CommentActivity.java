...
public class CommentActivity extends AppCompatActivity {
    ...
    private ImageView mEventImgViewBack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEventImgViewBack = (ImageView) findViewById(R.id.comment_main_back);
        ...
        mEventImgViewBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent eventIntent = new Intent(CommentActivity.this, EventActivity.class);
